...
A organização abaixo é inspirada na Design Science Research, sem afirmar que todo o ciclo
de avaliação com usuários foi concluído:
...
2. seleção dos registros 0000, 0150, 0200, C100, C170 e C190;
3. definição das perguntas de negócio e fórmulas;
