# Dossiê acadêmico do EFD Clara

Este dossiê registra a evolução do artefato e foi escrito para permitir o reaproveitamento
controlado no TCC. Os textos são base de trabalho: devem ser ajustados ao template, às
normas de citação e às orientações recebidas.

## Mapa dos documentos

1. [Problema e justificativa](01-problema.md)
2. [Objetivos](02-objetivos.md)
3. [Escopo e delimitação](03-escopo.md)
4. [Requisitos](04-requisitos.md)
5. [Arquitetura e privacidade](05-arquitetura.md)
6. [Indicadores de BI](06-indicadores-bi.md)
7. [Metodologia](07-metodologia.md)
8. [Casos de teste](08-casos-de-teste.md)
9. [Resultados do protótipo](09-resultados.md)
...
- valores do arquivo fictício devem ser reproduzíveis por teste;
- resultado técnico não deve ser apresentado como validação comercial;
