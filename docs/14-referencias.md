...
Lista em formato de trabalho. Ajustar à norma exigida pela PUCRS antes da entrega.

## Fontes normativas e técnicas

AGÊNCIA NACIONAL DE PROTEÇÃO DE DADOS. **Direito dos titulares**. Brasília, DF: ANPD.
Disponível em: <https://www.gov.br/anpd/pt-br/assuntos/titular-de-dados-1/direito-dos-titulares>.
Acesso em: 30 jul. 2026.

AGÊNCIA NACIONAL DE PROTEÇÃO DE DADOS. **Guia orientativo: tratamento de dados pessoais
para fins acadêmicos e para a realização de estudos e pesquisas**. Brasília, DF: ANPD,
2024. Disponível em:
...
CLOUDFLARE. **D1 limits**. Disponível em:
<https://developers.cloudflare.com/d1/platform/limits/>. Acesso em: 30 jul. 2026.

CLOUDFLARE. **D1 pricing**. Disponível em:
<https://developers.cloudflare.com/d1/platform/pricing/>. Acesso em: 30 jul. 2026.

RECEITA FEDERAL DO BRASIL. **Guia Prático da EFD ICMS/IPI: versão 3.2.2**. Atualização:
11 fev. 2026. Disponível em:
...
MACHADO, Bruno. **Infraestrutura para Big Data e Inteligência Artificial - Aula 1**.
Material didático PUCRS. O conteúdo discute transformação baseada em dados,
indicadores e arquitetura.

FERRETO, Tiago Coelho. **Infraestrutura para Big Data e Cloud Computing - Aula 3**.
Material didático PUCRS. O conteúdo aborda dados estruturados, volume, variedade e
veracidade.

SEVERO, Tatiana. **Liderança baseada em dados: DS e AI para gerir equipes - Aulas 1 e
2**. Material didático PUCRS. O conteúdo apresenta indicadores e dashboards como suporte à
gestão.
